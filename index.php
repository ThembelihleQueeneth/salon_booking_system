...
<body class="bg-white text-gray-900 font-sans">
  ...
  <nav class="w-full flex items-center justify-between px-6 md:px-16 py-5 bg-white shadow-sm sticky top-0 z-50">
    ...
    <ul class="hidden md:flex items-center gap-8 text-sm font-medium text-gray-700">
      <li class="hover:text-purple-600 cursor-pointer">Home</li>
      <li class="hover:text-purple-600 cursor-pointer">Services</li>
      <li class="hover:text-purple-600 cursor-pointer">Stylist</li>
      <li class="hover:text-purple-600 cursor-pointer">Gallery</li>
      <li class="hover:text-purple-600 cursor-pointer">About Us</li>
      <li class="hover:text-purple-600 cursor-pointer">Contact</li>
    </ul>

    <button class="bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded-xl font-medium shadow-md transition">
      Book Appointment
    </button>
  </nav>
  ...
  <!-- HERO SECTION -->
  <section class="hero px-6 md:px-16 py-14 bg-gradient-to-b from-purple-50 to-white">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between gap-10">
      ...
      <div class="here-content max-w-xl">
        ...
        <h1 class="text-4xl md:text-6xl font-extrabold leading-tight mt-4">
          Braids that <span class="text-purple-600">Empower.</span>
        </h1>
        ...
        <div class="flex items-center gap-4 mt-8">
          <button class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-xl font-semibold shadow-lg transition">
            Book Now →
          </button>

          <button class="border border-gray-300 hover:border-purple-500 px-6 py-3 rounded-xl font-semibold text-gray-700 transition">
            View All Services
          </button>
        </div>
  ...
  <section class="px-6 md:px-16 py-14">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
      ...
      <div class="bg-white rounded-2xl shadow-md hover:shadow-lg transition p-4 border border-gray-100">
        ...
        <p class="text-purple-600 font-bold mt-3">From R500</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-md hover:shadow-lg transition p-4 border border-gray-100">
        ...
        <p class="text-purple-600 font-bold mt-3">From R400</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-md hover:shadow-lg transition p-4 border border-gray-100">
        ...
        <p class="text-purple-600 font-bold mt-3">From R450</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-md hover:shadow-lg transition p-4 border border-gray-100">
        ...
        <p class="text-purple-600 font-bold mt-3">From R550</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-md hover:shadow-lg transition p-4 border border-gray-100">
        ...
        <p class="text-purple-600 font-bold mt-3">From R650</p>
      </div>
  ...
  <!-- HOW IT WORKS -->
  <section class="features px-6 md:px-16 py-16 bg-purple-50">
    <h2 class="text-3xl font-bold text-center mb-12">How it works</h2>

    <div class="steps grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
      
      <div class="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition">
        <div class="w-14 h-14 mx-auto flex items-center justify-center rounded-2xl bg-purple-600 text-white text-xl font-bold">
          1
        </div>
  ...
  <section class="reviews px-6 md:px-16 py-16 bg-white">
    ...
    <div class="reviews-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="review bg-white border border-gray-100 shadow-md rounded-2xl p-6 hover:shadow-lg transition">
        ...
        <p class="text-purple-600 font-semibold mt-4">★★★★★</p>
      </div>
  ...
  <!-- LAST CTA -->
  <section class="last px-6 md:px-16 py-16 bg-purple-50">
    <div class="bg-white rounded-3xl shadow-lg p-10 flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <div class="text-center">
        <button class="bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-2xl font-bold shadow-md transition">
          Book Appointment
        </button>
